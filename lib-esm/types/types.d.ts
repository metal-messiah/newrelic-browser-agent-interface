...
export declare type AddRelease = (releaseName: string, releaseId: string) => void;
export declare type AddPageAction = (name: string, attributes?: Record<string, SimpleType>) => void;
export declare type AddToTrace = (eventObject: EventObject) => void;
export declare type Finished = (timestamp?: number) => void;
export declare type NoticeError = (error: Error | string, customAttributes?: Record<string, SimpleType>) => void;
export declare type SetCustomAttribute = (name: string, value: SimpleType) => void;
export declare type SetErrorHandler = (filterCallback: ErrorHandler) => void;
export declare type SetPageViewName = (name: string, host?: string) => void;
export declare type Interaction = () => BrowserInteraction;
export declare type SetCurrentRouteName = (name: string | null) => void;
export declare type InlineHit = (t: Date, requestName: string, queueTime: number, appTime: number, totalBeTime: number, domTime: number, feTime: number) => void;
