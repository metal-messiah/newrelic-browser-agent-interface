...
exports.scoped = exports.global = void 0;
...
function noticeError(error, customAttributes) {
    return (0, core_1.executeMethod)(NewRelic.Callables.NOTICE_ERROR, error, customAttributes);
}
/**
...
function inlineHit(t, requestName, queueTime, appTime, totalBeTime, domTime, feTime) {
    return (0, core_1.executeMethod)(NewRelic.Callables.INLINE_HIT, t, requestName, queueTime, appTime, totalBeTime, domTime, feTime);
}
/**
...
function addRelease(releaseName, releaseId) {
    return (0, core_1.executeMethod)(NewRelic.Callables.ADD_RELEASE, releaseName, releaseId);
}
;
/**
...
function addPageAction(name, attributes) {
    return (0, core_1.executeMethod)(NewRelic.Callables.ADD_PAGE_ACTION, name, attributes);
}
;
/**
...
function addToTrace(eventObject) {
    return (0, core_1.executeMethod)(NewRelic.Callables.ADD_TO_TRACE, eventObject);
}
;
/**
...
function finished(timestamp) {
    return (0, core_1.executeMethod)(NewRelic.Callables.FINISHED, timestamp);
}
;
/**
...
function setCustomAttribute(name, value) {
    return (0, core_1.executeMethod)(NewRelic.Callables.SET_CUSTOM_ATTRIBUTE, name, value);
}
;
/**
...
function setErrorHandler(filterCallback) {
    return (0, core_1.executeMethod)(NewRelic.Callables.SET_ERROR_HANDLER, filterCallback);
}
;
/**
...
function setPageViewName(name, host) {
    return (0, core_1.executeMethod)(NewRelic.Callables.SET_PAGE_VIEW_NAME, name, host);
}
;
/**
...
function interaction() {
    return (0, core_1.executeMethod)(NewRelic.Callables.INTERACTION);
}
;
/**
...
function setCurrentRouteName(name) {
    return (0, core_1.executeMethod)(NewRelic.Callables.SET_CURRENT_ROUTE_NAME);
}
;
